 ...
 * @author Shai Almog
 */
public class PriceTrackerStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "PriceTracker";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new PriceTrackerStub());
    }
