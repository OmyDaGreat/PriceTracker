...
public class PriceTrackerStub extends CodenameOneActivity{
    public String d(String s) {
        return com.codename1.io.Util.xorDecode(s);
    }

    public static final String BUILD_KEY = "null";
    public static final String PACKAGE_NAME = "com.example.pricetracker";
    public static final String BUILT_BY_USER = "null";
    public static final String LICENSE_KEY = "null";
    String [] consumable = new String[]{};
    private static PriceTrackerStub stubInstance;
    private static PriceTracker i;
    private boolean running;
    private static boolean firstTime = true;
    private Form currentForm;
    private static final Object LOCK = new Object();
    public static PriceTracker getAppInstance() {
        return i;
    }
    ...
    public static PriceTrackerStub getInstance() {
        return stubInstance;
    }

    public PriceTrackerStub() {
        stubInstance = this;
    }
...
AndroidImplementation.startContext(this);
        ...
        Display.getInstance().callSerially(new Runnable(){
            ...
            public void run() {
                ...
                PriceTrackerStub.this.run(displayForm == null ? currForm : displayForm, wasStopped);
            }
        });
        synchronized(LOCK) {
            currentForm = null;
