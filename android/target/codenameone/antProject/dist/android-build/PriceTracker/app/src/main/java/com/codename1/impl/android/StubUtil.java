 ...
 * And  "com.example.pricetracker.PriceTrackerStub" (without quotes) with the fully qualified class name of the app stub.
 * @author shannah
 */
public class StubUtil {
    ...
    static boolean appIsRunning() {
        if (true) {
            return com.example.pricetracker.PriceTrackerStub.isRunning();
        }
        if (true) {
    ...
    static Class getAppStubClass() {
        if (true) {
            return com.example.pricetracker.PriceTrackerStub.class;
        }
        if (true) {
    ...
    static Object getMain() {
        if (true) {
            return com.example.pricetracker.PriceTrackerStub.getAppInstance();
        }
        if (true) {
